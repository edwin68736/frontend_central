...
import CollectionAlertsBell from '@/components/CollectionAlertsBell'
import {
  LayoutDashboard,
  Building2,
  Settings,
    ...
    <div className="flex h-screen overflow-hidden bg-slate-100">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center px-6 gap-4 flex-shrink-0">
          ...
          <CollectionAlertsBell />

          {/* Cuenta: vive en el header, no al pie del sidebar, para que quede al alcance
              aunque el menú lateral esté cerrado en pantallas chicas. */}
          <div className="relative" ref={userMenuRef}>
            ...
            >
              <span className="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center text-white text-sm font-bold flex-shrink-0">
            ...
            {userMenuOpen && (
              <div className="absolute right-0 top-full mt-1.5 w-48 bg-white rounded-lg shadow-lg border border-slate-200 overflow-hidden z-50">
